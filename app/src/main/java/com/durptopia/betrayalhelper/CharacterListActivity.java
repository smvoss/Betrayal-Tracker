...
import com.durptopia.betrayalhelper.dummy.DummyContent;
...
public class CharacterListActivity extends AppCompatActivity {
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        private final List<DummyContent.Character> mValues;

        public SimpleItemRecyclerViewAdapter(List<DummyContent.Character> items) {
            mValues = items;
        }
